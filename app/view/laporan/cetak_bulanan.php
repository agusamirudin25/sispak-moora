...
<td><hr/></td>
        ...
        <h2 style="text-align: center;margin-top:3%;">Laporan Tahun <?= $tahun ?> Bulan <?= $bulan ?></h2> <br>
        ...
        <table style="border: 0; border-collapse: collapse; margin-top: 6em; float:right;">
            <tr>
                <td style="width: 80%;">&nbsp;</td>
                <td>
                    <p>Bekasi, <?= tgl_indo(date('d-m-Y')) ?></p>
                    <p>Pakar</p>
                    <br>
                    <br>
                    <br>
                    <br>
                    <p>Alamsyah, STr. Keb</p>
                </td>
            </tr>
        </table>
